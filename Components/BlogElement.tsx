...
const BlogElement: React.FC<IBlog> = ({
  title,
  author,
  content,
  _id,
  ...
  return (
    ...
    >
      ...
      <Link href={`/resources/${_id}`}>
        <div className='py-2 px-4 rounded-md bg-white transition-all duration-200 hover:bg-black hover:text-white cursor-pointer shadow-md w-max'>
          Read full blog
        </div>
      </Link>
    </div>
